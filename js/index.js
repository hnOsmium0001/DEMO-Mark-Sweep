...
const obj_o1_1 = VirtualObject.create(2, [obj_o3], heap); // 0
const obj_o1 = VirtualObject.create(3, [obj_o1_1], heap); // 1

const obj_o2_1 = VirtualObject.create(2, [obj_o3, obj_o2_2], heap); // 2
...
const randomObj1 = VirtualObject.create(2, [randomObj2], heap); // 8
const randomObj2 = VirtualObject.create(8, [randomObj1, obj_o1, obj], heap) // 9

const selfObj = VirtualObject.create(1, [selfObj], heap) // 10
